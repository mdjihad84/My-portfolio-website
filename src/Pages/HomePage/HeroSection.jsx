    ...
    return (
        <div className="flex flex-col-reverse gap-[135px] lg:flex-row items-center justify-around p-6 lg:p-12 lg:ml-[-44px] lg:mt-[100px]">
            <div className="text-center lg:text-left">
                ...
                <p className='text-white leading-6 lg:leading-[25px] font-semibold w-full lg:w-[610px] my-4'>From Dhaka, Bangladesh. I’m a Front End Web developer who is passionate about making error-free websites. I am good at WordPress. I love to talk with you about your unique.</p>
