    ...
    return (
        <div className="flex flex-col-reverse gap-[135px] lg:flex-row items-center justify-around p-6 lg:p-12 lg:ml-[-44px] lg:mt-[80px]">
            <div className="text-center lg:text-left">
                ...
                <h2 className='text-white font-Poppins text-3xl lg:text-5xl uppercase font-semibold my-4 lg:my-6 lg:w-[640px]'>MD JAHIDUL ISLAM ( JIHAD )</h2>
                ...
                <button className='text-white text-base lg:text-lg font-semibold px-5 lg:px-[20px] font-Sans-serif w-[160px] lg:w-[190px] h-[48px] lg:h-[58px] rounded-full bg-[#f8b90c] shadow-custom flex items-center justify-center text-center animate-button-move'>
                    Contact
                </button>
            </div>
            <div className="relative mt-8 lg:mt-0">
                ...
                <div className="flex absolute mt-[-120px] lg:mt-[-175px] animate-move-vertical flex-col lg:flex-row">
